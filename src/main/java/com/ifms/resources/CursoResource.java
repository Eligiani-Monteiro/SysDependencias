...
import com.ifms.services.CursoService;
...
public class CursoResource {
	...
	@GetMapping
	public ResponseEntity<Page<CursoDTO>> findAllPaged(@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "linesPerPage", defaultValue = "12") Integer linesPerPage,
			@RequestParam(value = "direction", defaultValue = "ASC") String direction,
			@RequestParam(value = "orderBy", defaultValue = "nomeCurso") String orderBy) {
